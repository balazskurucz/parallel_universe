<x-app-layout>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.news.update', $newsBroadcast) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $newsBroadcast->image_path ? 'Replace News Image' : 'News Image' }}
                </label>
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                <span>{{ $newsBroadcast->image_path ? 'Upload new image' : 'Upload a news image' }}</span>
            ...
            <div>
                ...
                <input type="url" id="video_url" name="video_url" value="{{ old('video_url', $newsBroadcast->video_url) }}"
                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md text-gray-900"
